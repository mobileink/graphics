...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{tikzpicture}[scale=2,domain=-.3:1.3]
...
%% f(x) = 1/x
  \draw[green,ultra thick,domain=.3:3.2,samples=100] plot (\x,{(1/\x)});
  \draw[green,ultra thick] (.35,3.1) node[above right] {$f(x) = \frac{1}{x}$};
